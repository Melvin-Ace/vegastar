...
class ProfileView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            local_town = form.cleaned_data['local_town']

            reg = Customer(user=user, firstname=firstname, email=email, mobile=mobile, county=county,
                           local_town=local_town)
            reg.save()
            messages.success(request, "Congratulations! Profile Saved Successful")
        else:
...
class updateAddress(View):
    ...
    def post(self, request, pk):
        ...
        if form.is_valid():
            ...
            add.local_town = form.cleaned_data['local_town']
            add.save()
            messages.warning(request, "Congratulations! Your profile has been successfully updated")
        else:
            messages.warning(request, "Invalid Input Data! kindly fill in with valid details")
